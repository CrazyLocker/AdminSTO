...
& "$JDK_PATH\bin\jlink.exe" --module-path "$JDK_PATH\jmods" --add-modules java.base,java.sql,jdk.unsupported --strip-debug --no-man-pages --no-header-files --compress=2 --output "$distDir\jre"
...
Write-Host "  3. JDK НЕ НУЖЕН!" -ForegroundColor Green
Write-Host ""
