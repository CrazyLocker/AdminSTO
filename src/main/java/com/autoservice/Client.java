...
public class Client {
    ...
    /**
     * Отображение автомобилей клиента. Приоритет: список cars, fallback — старые поля.
     */
    public String getCarDisplay() {
        if (cars != null && !cars.isEmpty()) {
            return String.join(", ", cars.stream().map(Car::getDisplayName).toArray(String[]::new));
        }
        return (carModel != null && !carModel.isEmpty()) ? carModel + (carNumber != null && !carNumber.isEmpty() ? " " + carNumber : "") : "";
    }
